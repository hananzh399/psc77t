...
let ip = document.querySelector('.mb-serach-input');
 ...
 mbSearchOpen.addEventListener('click', ()=>{
    ...
    let verticalDevider1 = document.querySelector('.vartical-devider1');
    let verticalDevider12 = document.querySelector('#vartical-devider12');
    verticalDevider1.style.visibility = "hidden";
    verticalDevider12.style.visibility = "hidden";
    ip.focus();
 });
